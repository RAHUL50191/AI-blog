          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                <Link to="#home" className="mb-6 items-center space-x-3 rtl:space-x-reverse max-w-[160px] flex">
                ...
                <p className="mb-7 text-base text-body-color dark:text-dark-6">
                  AI BLOGS -detailed articals on lastest AI tech and tool stay updated with time!
                </p>
                <p className="flex items-center text-sm font-medium text-dark dark:text-white">
                  ...
                  <span>+91 31314 55213</span>
                </p>
              </div>
            </div>

            <LinkGroup header="Resources">
              <NavLink link="/#" label="Development AI" />
              <NavLink link="/#" label="Production AI" />
              <NavLink link="/#" label="Robotics" />
              <NavLink link="/#" label="GPT" />
            </LinkGroup>
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="text-base text-body-color dark:text-dark-6">
                  &copy; {new Date().getFullYear()} AI Blogs
                </p>
              </div>
            </div>
          </div>
